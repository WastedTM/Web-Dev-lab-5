...
export const DataContextProvider = ({ children }) => {
    ...
    const description =
        "Бренд KIMBERLI був заснований в 2005 році, у Вінниці, ювелірній столиці України та кузні майстрів ювелірної справи, відомої далеко за межами країни. Своїм ім'ям компанія віддає належну повагу найбільшому в світі родовищу алмазів – місту Кімберлі в Південній Африці. Воно стало символом, вагомим ім'ям в алмазній промисловості, та гордістю нації, завдяки KIMBERLI JEWELRY HOUSE.";

    return <DataContext.Provider value={{ title, description }}>{children}</DataContext.Provider>;
};
...
export const UserContextProvider = ({ children }) => {
    const username = "User12345678"
    const someText = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."

    return (
        <UserContext.Provider value={{ username,  someText}}>
            {children}
